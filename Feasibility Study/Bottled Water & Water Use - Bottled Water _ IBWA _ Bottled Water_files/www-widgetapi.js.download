...
;function Ll(){}
function Ml(a,b,c){var d,e,f;return y(function(g){if(1==g.h){if(!R("gcf_config_store_update_enabled"))return g.s(0);c&&(a.h=c,B("yt.gcf.config.hotConfigGroup",a.h));a.hotHashData=b;B("yt.gcf.config.hotHashData",a.hotHashData);return(d=rl())?c?g.s(4):x(g,Kl(d),5):g.s(0)}4!=g.h&&(e=g.i,c=null==(f=e)?void 0:f.config);return x(g,Hl(c,b,d),0)})}
function Nl(a,b,c){var d,e,f,g;return y(function(h){if(1==h.h){if(!R("gcf_config_store_update_enabled"))return h.s(0);a.coldHashData=b;B("yt.gcf.config.coldHashData",a.coldHashData);return(d=rl())?c?h.s(4):x(h,Jl(d),5):h.s(0)}4!=h.h&&(e=h.i,c=null==(f=e)?void 0:f.config);if(!c)return h.s(0);g=c.configData;return x(h,Il(c,b,g,d),0)})}
